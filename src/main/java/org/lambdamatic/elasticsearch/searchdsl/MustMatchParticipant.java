 ...
 */
public interface MustMatchParticipant<D, Q> {

  /**
   * The clause (query) <strong>must</strong> appear in matching documents and will contribute
   * to the score.
   * 
   * @param queryExpression the <strong>query expression</strong> to pass in the document search
   *        request
   */
  public MustMatchContext<D, Q> mustMatch(QueryExpression<Q> queryExpression);
