 ...
 */
public interface ShouldMatchParticipant<D, Q> {

  /**
   * The clause (query) <strong>should</strong> appear in matching documents and will contribute to
   * the score.
   * 
   * @param queryExpression the <strong>query expression</strong> to pass in the document search
   *        request
   */
  public ShouldMatchContext<D, Q> shouldMatch(QueryExpression<Q> queryExpression);
