...
public class GetSubscription implements Subscription {
   ...
   */
  public GetSubscription(final Subscriber<? super GetResponse> subscriber, final GetRequestBuilder requestBuilder) {
  ...
  public void request(final long n) {
    if(!this.cancelled.get()) {
      this.requestBuilder.setFetchSource(true).setFields("title").execute(new ActionListener<GetResponse>() {
